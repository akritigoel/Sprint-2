...
public class TestController {
	...
	// add new test
	@PostMapping("/addTest")
	public String addTest(@RequestBody Assessment test) {
	...
	public String updateTest(@PathVariable(value = "id") BigInteger testId, @RequestBody Assessment testdetails)
	...
	public String assignTest(@PathVariable(value="id")BigInteger testId) throws RecordNotFoundException {
		...
		Assessment test =testdao.findById(testId).orElseThrow(()->new RecordNotFoundException("Test not found for given id" +testId));
